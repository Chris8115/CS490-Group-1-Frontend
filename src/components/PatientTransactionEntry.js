            ...
            <div className="default-card">
                ...
                <table>
                    <tr>
                        ...
                        <td>{(transaction.doctor_fee.toString().includes('$') ? "" : "$")}{transaction.doctor_fee}</td>
                    </tr>
                    <tr>
                        <td><strong>Service Fee: </strong></td>
                        <td>{(transaction.service_fee.toString().includes('$') ? "" : "$")}{transaction.service_fee}</td>
                    </tr>
                    <tr>
                        <td><strong>Subtotal: </strong></td>
                        <td>{(transaction.subtotal.toString().includes('$') ? "" : "$")}{transaction.subtotal}</td>
                    </tr>
                </table>
